...
namespace Algo
{
    ...
    {
        static public Dictionary<int, User> ReadUsers( string path, out Dictionary<int,List<User>> duplicates )
        {
            ...
            using( TextReader r = File.OpenText( path ) )
            {
                ...
                while( (line = r.ReadLine()) != null )
                {
                    ...
                    if( result.TryGetValue( u.UserID, out exists ) )
                    {
                        List<User> list;
